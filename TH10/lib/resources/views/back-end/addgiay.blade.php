	...
	@section('title', 'Thêm sản phẩm giày')
	@section('main')
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										...
										<input required type="number" name="price" class="form-control" value="99999">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										<input required type="number" name="soluong" class="form-control">
									</div>
